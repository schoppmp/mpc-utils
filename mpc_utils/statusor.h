...
#include "mpc_utils/statusor_internals.h"
...
class StatusOr : private internal_statusor::StatusOrData<T>,
 ...
 public:
  ...
  // of passing mpc_utils::error::INTERNAL as a fallback.
...
template <typename T>
StatusOr<T>::StatusOr() : Base(Status(mpc_utils::error::UNKNOWN, "")) {}
